...
We are Hawkeye INC and we have recently acquired a company called Jewel. We both sold some of the same products, and our goal is to integrate all of our company processes into a single form. In other words, we are migrating the data from Jewel and their processes and incorporating them into our own.

Goals:
1. Incorporate Jewel company table into Hawkeye customer table, making sure we have no duplications. If we have a duplication, note it in the source code at the bottom and do not import that company. In other words, if we have a duplication, we do not create a separate company listing for them; we use our existing company ID for them. This is very important in step E.
2. Merge product tables and product keys from Jewel to Hawkeye. Match where you can, create new otherwise. No duplications.
3. Clean up the Hawkeye customer table and add contact as a secondary key to the contact table and remove the contact name in the customer table once you have completed.
4. When importing contact information, do not duplicate contact records. If we have the same person as a contact in two companies, make sure they do not have separate records in the Hawkeye contact table. If we have two different contact people for the same company, use Hawkeye contacts.
